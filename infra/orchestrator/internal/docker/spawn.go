...
func Spawn(ctx context.Context, c Client, in SpawnInputs) (map[string]string, error) {
	...
	proxyHC.Tmpfs = map[string]string{
		"/var/run/squid":   "uid=1001,gid=1001,mode=750",
		"/var/log/squid":   "uid=1001,gid=1001,mode=750",
		"/var/spool/squid": "uid=1001,gid=1001,mode=750",
		"/var/lib/haproxy": "uid=1001,gid=1001,mode=750",
		"/run":             "uid=1001,gid=1001,mode=750",
		"/tmp":             "uid=1001,gid=1001,mode=750",
	}
